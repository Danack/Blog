...
vendor/bin/configurate -p data/config.php data/config/nginx.conf.php autogen/nginx.conf $environment
vendor/bin/configurate -p data/config.php data/config/php-fpm.conf.php autogen/php-fpm.conf $environment
vendor/bin/configurate -p data/config.php data/config/project.php.ini.php autogen/php.ini $environment
