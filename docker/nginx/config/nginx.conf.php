...
$normalBlock = createServerBlock(
    ...
    $phpBackend = 'blog_php_fpm:9000',
    'non-debug php backend'
);

$debugBlock = createServerBlock(
    $portStrings   = ['8001'],
    $domains = [
        '*.basereality.com',
        'basereality.com',
    ...
    $root = '/var/www/public',
    $indexFilename = 'index.php',
    $phpBackend = 'blog_php_fpm_debug:9000',
    'debug php backend'
);
...
http {
    ...
    include /var/www/docker/nginx/config/mime.types;
